            ...
            <div tabindex="-1"
                ...
                >
                    <div>
                        ...
                        <p class="text-80 px-8" :class="(showTextField || showTextArea) ? 'my-4' : 'my-8'">
                            {{question}}
                        </p>
                        ...
                        <div class="my-4" v-if="showTextArea">
                            <div class="flex">
                                <div class="w-1/5 py-6 px-8" v-if="showTextArea && textAreaLabel">
                                    <label class="inline-block text-80 pt-2 leading-tight">
                                        {{textAreaLabel}}
                                    </label>
                                </div>
                                <div class="py-6 px-8 w-4/5" v-if="showTextArea && textAreaPlaceholder">
                                    <textarea class="w-full shadow-inner p-4 border-0"
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            handleConfirm() {
                this.$emit('confirm', this.textField || this.textArea);
