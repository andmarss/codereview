<template>
    <loading-view :loading="loading">
        <heading class="mb-6">Проверка данных</heading>
...
<script>
    ...
    export default {
        ...
        mounted(){
            this.updatePage(this.usersPage).then(() => {
                this.loading = false;
            });
        },
        ...
        methods: {
            ...
            updatePage(page){
                ...
                return axios.post('/api/information/specialists', {
                    page,
                    email,
        ...
        beforeRouteLeave(to, from, next){
            Nova.usersStore.dispatch('updateUsersPage', 1);
